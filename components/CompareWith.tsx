    ...
    <div className="bg-white border rounded-xl p-6 shadow-sm mt-8">
      ...
      <div className="flex flex-col md:flex-row gap-4">
        <input
          ...
          className="flex-1 px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent"
        />

        <button
          onClick={handleCompare}
          disabled={!otherUrl.trim()}
          className="px-6 py-3 bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
        >
