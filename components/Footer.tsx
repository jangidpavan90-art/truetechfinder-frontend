  ...
  return (
    <footer className="bg-white border-t border-[#DCE4EC] mt-16">
      <div className="max-w-6xl mx-auto px-6 py-10 grid md:grid-cols-3 gap-8">
        ...
        <div>
          <h4 className="font-semibold mb-3 text-[#1A2A45]">Product</h4>
          <ul className="space-y-2 text-sm text-[#4A5A70]">
            <li><Link href="/scan" className="hover:text-[#FF8A3D] transition">Scan</Link></li>
            <li><Link href="/compare" className="hover:text-[#FF8A3D] transition">Compare</Link></li>
            <li><Link href="/pricing" className="hover:text-[#FF8A3D] transition">Pricing</Link></li>
          </ul>
        </div>

        <div>
          <h4 className="font-semibold mb-3 text-[#1A2A45]">Company</h4>
          <ul className="space-y-2 text-sm text-[#4A5A70]">
            ...
            <li><Link href="/privacy" className="hover:text-[#FF8A3D] transition">Privacy</Link></li>
          </ul>
        </div>
